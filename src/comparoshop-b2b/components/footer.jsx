...
const Footer = () => {
    ...
    return <>
        <div style={footerStyles} className={`flex flex-col justify-between text-[${styles.colors.black}]`}>
            <div className={`py-20 max-w-[1000px] w-full mx-auto flex flex-col items-center md:flex-row md:justify-around  p-${styles.defaultPadding}`}>
                ...
                <div className={`w-full max-w-[300px] md:pl-4 text-center md:text-start`}>
                    ...
                    <ul className={`flex justify-center md:justify-start items-center m-1 mt-4 md:m-4 md:ml-0`}>
                        <li><span className={`block cursor-pointer py-1 px-3 md:py-3 md:px-5 mr-2 rounded-sm bg-[${styles.colors.orange}] hover:underline`}>f</span></li>
                        <li><span className={`block cursor-pointer py-1 px-3 md:py-3 md:px-5 mr-2 rounded-sm bg-[${styles.colors.orange}] hover:underline`}>tw</span></li>
                        <li><span className={`block cursor-pointer py-1 px-3 md:py-3 md:px-5 mr-2 rounded-sm bg-[${styles.colors.orange}] hover:underline`}>in</span></li>
                    </ul>
