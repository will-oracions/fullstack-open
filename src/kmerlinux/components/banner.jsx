...
function Banner() {
    return <>
        <div className="bg-[#2A3E52] relative">
            <img className="absolute z-10 w-full h-[506px] object-cover" src={BannerImage} alt="Work flow" />
            <div className="relative z-20 max-w-screen-2xl mx-auto w-full h-[506px] text-white">

                <div className="max-w-screen-xl text-lg text-center mx-auto absolute top-0 bottom-0 left-0 right-0 flex flex-col justify-between items-center py-8">
